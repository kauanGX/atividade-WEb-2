...
class AuthorController extends Controller
{
    ...
    public function update(Request $request, Author $author)
    {
        ...
        return redirect()->route('authors.index')->with('success', 'Autores atualizado com sucesso.');
    }
    ...
    {
        $author->delete();
        return redirect()->route('authors.index')->with('success', 'Autores excluído com sucesso.');
    }
}
